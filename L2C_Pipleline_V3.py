...
for s_file in source_files:
    ...
    for t_file in target_files:
        if countryname in t_file:
            ...
            target_file_final = str(input_path) + str(t_file)
            ...
            # xlsx file to csv
            df1 = pd.read_excel(source_file,sheet_name='Estimate Master')
            new_df = df1.drop([0, 1, 2, 3])
            new_df.to_csv(str(output_file_path) + 'BR_EstimateMaster_source.csv', index=False, header=False, encoding='UTF-8')

            with open(str(output_file_path) + 'BR_EstimateMaster_source.csv', newline='') as f:
                reader = csv.reader(f)
                data = list(reader)
            ...
            sheet1.write(7, 0, 'Non numeric value check for 2020_Q1')
            sheet1.write(8, 0, 'Non numeric value check for 2020_Q2')
            sheet1.write(9, 0, 'Non numeric value check for 2020_Q3')
            sheet1.write(10, 0, 'Non numeric value check for 2020_Q4')
            sheet1.write(11, 0, 'Non numeric value check for Total')
            '''
            sheet1.write(12, 0, 'Negative value check for Q1')
            sheet1.write(13, 0, 'Negative value check for Q2')
            sheet1.write(14, 0, 'Negative value check for Q3')
            sheet1.write(15, 0, 'Negative value check for Q4')
            sheet1.write(16, 0, 'Negative value check for Total')
            '''
            ...
            if Q1_non_numeric_values_count == 0:
                ...
                error_count = error_count + 1
                sheet1.write(7, 2, '2020_Q1 contains ' + str(Q1_non_numeric_values_count) + ' values')
            ...
            if Q2_non_numeric_values_count == 0:
                ...
                error_count = error_count + 1
                sheet1.write(8, 2, '2020_Q2 contains ' + str(Q2_non_numeric_values_count) + ' values')
            ...
            if Q3_non_numeric_values_count == 0:
                ...
                error_count = error_count + 1
                sheet1.write(9, 2, '2020_Q3 contains ' + str(Q3_non_numeric_values_count) + ' values')
            ...
            if Q4_non_numeric_values_count == 0:
                ...
                error_count = error_count + 1
                sheet1.write(10, 2, '2020_Q4 contains ' + str(Q4_non_numeric_values_count) + ' values')
            ...
            if Total_non_numeric_values_count == 0:
                ...
                error_count = error_count + 1
                sheet1.write(11, 2, '2020_Q4 contains ' + str(Total_non_numeric_values_count) + ' values')
            ...
            body = template.render(
                rev_type='Pipeline Revenue',
                date= date.today(),
                market= countryname,
                status= email_status,
                file_name = 'PipelineRevenue_{0}'.format(countryname),
